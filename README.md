...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jrio6fu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jrio6fu.containers.anotherwebservice.com/
...
```
git clone git@github.com:rshadow/container-jrio6fu.git
cd container-jrio6fu
```
...
```
docker attach container-jrio6fu
```
